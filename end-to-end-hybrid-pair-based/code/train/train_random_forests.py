...
output_model_path = os.path.join(config.TRAINED_MODELS_PATH, 'random_forest_model.joblib')

# Get model-specific parameters from config
model_params = config.MODEL_CONFIGS.get('RandomForestClassifier', {})
# RandomForestClassifier uses parameters directly in the constructor
...
print("-" * 50)
print(f"Using Random Forest parameters: {model_params}")
print("-" * 50)
...
try:
    ...
    # RandomForestClassifier supports sparse input for fit
...
print("\n--- Random Forest Training Script Finished ---")
